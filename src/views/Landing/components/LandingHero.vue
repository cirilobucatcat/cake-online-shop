<template>
    <section class="relative h-[calc(100%-200px)] overflow-hidden">
        <img 
            id="img-hero" 
            class="size-[15rem] md:size-[25rem] xl:size-[30rem] top-50 md:top-50 lg:top-50 xl:top-60 2xl:top-80  absolute-center"
            :src="heroImg" 
        ...
        <h1 class="relative text-xl text-nowrap md:text-3xl lg:text-5xl xl:text-6xl font-bold font-bubblegum-sans text-shadow-md">
            <span id="text-hero-1" class="text-rose-600 absolute top-30 md:top-30 lg:top-30 xl:top-30 2xl:top-50 bg-white/50 px-8 py-4 [clip-path:polygon(4%_0%,100%_1%,95%_100%,0%_100%)]">Freshly Baked Cakes</span>
            <span id="text-hero-2" class="text-teal-600 absolute top-50 md:top-55 lg:top-55 xl:top-60 2xl:top-80 right-0 md:right-20 bg-white/50 px-8 py-4 [clip-path:polygon(4%_0%,100%_1%,95%_100%,0%_100%)]">Delivered to Your Doorstep</span>
        </h1>
        <p id="subtext-hero" class="text-teal-600/75 top-[60%] md:top-[65%] xl:top-[55%] 2xl:top-[80%]  text-center text-sm md:text-base xl:text-xl font-medium absolute-center w-[85%] md:w-none">Indulge in handcrafted cakes made with love, perfect for every occasion.</p>
        <button data-testid="btn-cta" id="btn-cta" class="absolute-center btn-hero top-[70%] md:top-[75%] xl:top-[63%] 2xl:top-[90%] flex justify-center items-center space-x-2 xl:w-[200px] xl:h-[55px]">
...
const breakpoints = [
    { query: '(max-width: 425px)', left: '10%', right: '5%' },
    { query: '(width: 768px)', left: '20%', right: '15%' },
    { query: '(width: 1024px)', left: '15%', right: '15%' },
    { query: '(width: 1440px)', left: '20%', right: '20%' },
    { query: '(min-width: 1536px)', left: '30%', right: '30%' },
];
